...
export const UploadIcon = ({ classname, width = "1.2em", height = "1.2em" }) => {
    return (
        <svg
            className={classname}
            width={width}
...
export const MessageIcon = ({ classname, width = "1em", height = "1em" }) => {
    return (
        <svg
            className={classname}
            width={width}
...
export const MessageBoxIcon = ({ classname, width = "3.2rem", height = "3.2rem" }) => {
    return (
        <svg
            className={classname}
            width={width}
